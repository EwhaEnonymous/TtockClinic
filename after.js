        ...
        <View style = {styles.body}>
            ...
            <View style = {styles.container3}>
                <View style = {styles.container31}>
                    <TouchableOpacity style={styles.checkQR} onPress={() => Alert.alert("QR 보기")}>
                        <Text style={styles.but}>내 QR 보기</Text>
                    </TouchableOpacity>
                </View>
                <View style = {styles.container31}>
                    <TouchableOpacity style={styles.home} onPress={() => Alert.alert("Home")}>
            ...
            <View style = {styles.container4}>
                ...
                <Text style = {styles.guide}>선별진료소에 도착하면
                {"\n"}QR 인식기에 나의 QR을 인식하고 
                {"\n"}자신의 차례가 올 때까지 기다리세요</Text>
            </View>
